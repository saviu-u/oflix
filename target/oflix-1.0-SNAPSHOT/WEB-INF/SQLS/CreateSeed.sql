...
INSERT INTO tb_filme(id_catg, nome_filme, sinopse, quant_estoque, class_indicativa)
VALUES
(1, 'Indiana Jones e Os Salteadores da Arca Perdida', 'O arqueólogo Indiana Jones precisa encontrar a Arca da Aliança, uma relíquia bíblica que contém os dez mandamentos. Como o portador do artefato se torna invencível, os nazistas também vão fazer de tudo para adquirir esse precioso objeto.', 3, 11),
(1, 'Star Wars: Episódio IV – Uma Nova Esperança', 'A princesa Leia é mantida refém pelas forças imperiais comandadas por Darth Vader. Luke Skywalker e o capitão Han Solo precisam libertá-la e restaurar a liberdade e a justiça na galáxia.', 1, 11);
