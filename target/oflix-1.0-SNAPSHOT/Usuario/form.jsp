                                ...
                                <select name="id_func">
                                    ...
                                    <%
                                        for(String key : functions.keySet()){
                                            String selected = "";
                                            if(params.get("id_func") != null && functions.get(key).equals(params.get("id_func")[0])) selected = "selected";
                                            out.println("<option value=" + functions.get(key)+ " " + selected + ">" + key + "</option>");
                                        }
                                    %>
                                </select>
                                <% if(errors.get("id_func") != null) out.println("<div>"+ errors.get("id_func") +"</div>"); %>
                            </fieldset>
